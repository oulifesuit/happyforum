            ...
            <li class="active treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li><a href="/user/alterUser"><i class="fa fa-circle-o"></i> 个人资料</a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i> 好友管理</a></li>
            ...
            <li class="active treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="/postlist"><i class="fa fa-circle-o"></i> 内容列表</a></li>
                </ul>
            </li>
        </ul>
    </section>
